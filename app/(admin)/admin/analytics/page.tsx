    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
          <h2 className="font-heading text-lg font-semibold text-white mb-4">Popular Pages</h2>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
          <h2 className="font-heading text-lg font-semibold text-white mb-4">Setup Google Analytics</h2>
          ...
          <button className="mt-6 rounded-xl bg-orange-500/100 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-orange-600">
            Connect Now
          </button>
        </div>
      </div>
