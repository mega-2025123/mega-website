      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="card-jaswanth-24 text-center animate-fadeInUp">
          <div className="flex flex-col items-center space-y-8">
            ...
            {/* Header Tag */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-400 text-xs font-bold uppercase tracking-[0.2em]">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white tracking-tight leading-tight max-w-3xl">
              Uniting Passion, Hands-on Innovation, & <span className="shimmer-text">Technical Excellence</span>
            </h2>

            {/* Paragraph Text */}
            <p className="text-gray-300 font-light text-base sm:text-lg leading-relaxed max-w-4xl">
            ...
            <div className="w-full my-4 p-8 sm:p-10 rounded-[24px] bg-[#111111]/60 border border-orange-500/25 text-center relative overflow-hidden shadow-[0_0_40px_rgba(255,69,0,0.15)] backdrop-blur-md hover:border-orange-500/40 transition-colors duration-300">
              <div className="flex flex-col items-center space-y-3 relative z-10">
                ...
                <h3 className="text-2xl sm:text-4xl md:text-5xl font-black text-white tracking-tight font-heading">
                  "One Guild, <span className="shimmer-text">Infinite Possibilities</span>"
                </h3>
              </div>
            </div>
