      ...
      <div className="max-w-6xl w-full bg-[#141414]/20 border border-[#2F2F2F] rounded-3xl p-8 md:p-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 md:gap-12">
          ...
          <div className="space-y-4 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#141414] border border-[#F97316]/40 text-[#F97316] text-xs font-semibold tracking-wider">
            ...
            <div className="text-xs sm:text-sm text-[#B3B3B3] flex items-start gap-3 pt-3">
          ...
          <div className="shrink-0 flex justify-start lg:justify-end">
            <Link
              href="/blog"
              className="btn-jaswanth-primary group w-full sm:w-auto text-center justify-center px-8 py-3.5 text-xs md:text-sm"
            >
