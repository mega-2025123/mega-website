...
export const DepartmentSection = ({ openOfficialMessage }) => {
  ...
  return (
    <section className="py-16 md:py-24 px-4 sm:px-6 md:px-12 w-full flex justify-center bg-[#111111]">
      <div className="max-w-6xl w-full space-y-20">
        ...
        <div className="w-full">
          ...
          <div className="card-jaswanth-24 flex flex-col md:flex-row items-center gap-8 text-center md:text-left group hover:border-[#F97316] transition-all duration-300">
            <div className="w-32 h-32 md:w-40 md:h-40 rounded-2xl overflow-hidden border border-[#2F2F2F] bg-[#121212] shrink-0 shadow-2xl relative group-hover:scale-105 transition-transform duration-300">
              {!hodErr ? (
                <img 
                  src="/assets/Hod.jpg" 
                ...
                <div className="w-full h-full flex items-center justify-center bg-[#121212] border border-[#2F2F2F] text-[#F97316] font-heading font-black text-4xl">
                  BR
                </div>
              )}
            </div>
            ...
            <div className="space-y-3">
              ...
              <h3 className="text-2xl md:text-3xl font-bold font-heading text-white group-hover:text-[#F97316] transition-colors">
                Mr. B. Ramanjaneyulu
              </h3>
        ...
        <div className="w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {facultyList.map((faculty, idx) => {
              ...
              return (
                <div key={idx} className="card-jaswanth-24 flex flex-col items-center text-center group hover:border-[#F97316] transition-all duration-300">
                  <div className="w-24 h-24 rounded-2xl overflow-hidden border border-[#2F2F2F] bg-[#121212] mb-4 shrink-0 shadow-md relative group-hover:scale-105 transition-transform duration-300">
                    {faculty.image && !fErr ? (
                      <img 
                        src={faculty.image} 
                        alt={faculty.name}
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-[#121212] border border-[#2F2F2F] text-[#F97316] font-heading font-black text-xl">
                        {faculty.initials}
                      </div>
                    )}
                  </div>
                  <h4 className="text-base font-bold font-heading text-white group-hover:text-[#F97316] transition-colors">
                    {faculty.name}
                  </h4>
        ...
        <div className="w-full">
          <div className="card-jaswanth-24 fire-border-left flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left group hover:border-[#F97316] transition-all duration-300">
            <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl overflow-hidden border border-[#2F2F2F] bg-[#121212] shrink-0 shadow-xl relative group-hover:scale-105 transition-transform duration-300">
              {!balaErr ? (
                ...
                <div className="w-full h-full flex items-center justify-center bg-[#121212] border border-[#2F2F2F] text-[#F97316] font-heading font-black text-2xl">
                  MB
                </div>
              )}
            </div>
