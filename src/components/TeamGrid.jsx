  ...
  return (
    <section id="team" className="pb-20 pt-2 px-4 sm:px-6 md:px-12 max-w-6xl mx-auto w-full flex justify-center bg-[#090909]">
      <div className="w-full space-y-10">
        ...
        {/* 11 Office Bearers Grid - No Card Boxes */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {teamMembers.map((member, index) => {
            ...
            return (
              <div 
                key={index} 
                className="flex flex-col justify-between group text-center sm:text-left border-t border-[#2F2F2F] pt-6"
              >
                <div>
                  {/* Photo / Avatar */}
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-20 h-20 rounded-2xl overflow-hidden bg-[#090909] shrink-0 relative">
                    ...
                    <div className="flex items-center gap-2">
                      {member.whatsapp && (
                        <a 
                          ...
                          className="w-8 h-8 rounded-full bg-[#141414] border border-[#2F2F2F] flex items-center justify-center text-white hover:border-[#F97316]"
                ...
                <div className="mt-4 pt-3 flex items-center justify-between text-[11px] text-[#B3B3B3] font-medium">
