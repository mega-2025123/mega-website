...
export const Hero = () => {
  return (
    <section id="home" className="w-full min-h-[calc(100vh-6rem)] flex items-center justify-center pt-12 sm:pt-16 md:pt-20 pb-28 px-4 sm:px-6 md:px-12 relative text-center overflow-hidden bg-[#090909]">
      <div className="max-w-6xl mx-auto w-full flex flex-col items-center text-center z-10">
        {/* Generous top clearance spacer to guarantee zero overlap with floating navbar */}
        <div className="h-28 sm:h-36 md:h-44 lg:h-48 shrink-0" />
