...
export const Hero = () => {
  return (
    <section id="home" className="w-full min-h-screen pt-28 sm:pt-32 md:pt-36 pb-12 px-4 sm:px-6 md:px-12 flex flex-col items-center justify-start text-center relative overflow-hidden bg-[#090909]">
      <div className="max-w-6xl mx-auto w-full flex flex-col items-center text-center">
        
        {/* High-Contrast Tracking Badge Pill: Placed BELOW the Floating Navigation Bar */}
