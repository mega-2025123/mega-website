...
export const Hero = () => {
  return (
    <section id="home" className="w-full min-h-screen pt-24 sm:pt-28 md:pt-32 pb-12 px-4 sm:px-6 md:px-12 flex flex-col items-center justify-start text-center relative overflow-hidden bg-[#090909]">
